<div class="d-flex justify-content-end mt-5">
    <div>
        <form action="/admin/shipments/search/id" class="d-flex" action="" method="POST">

            <a href="/admin/shipments/create-laptop?id=<?php echo s($_GET['id']);  ?>" class="btn btn-success mx-3">Crear nuevo registro</a>

            <input type="search" name="numero_serie" id="search" class="form-contol" aria-label="search">
